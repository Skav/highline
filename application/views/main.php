...
<body onload="timer();"  data-spy="scroll" data-target=".navbar" data-offset="50">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <?php if($rank['r_pa'] == "yes" || $rank['r_all'] == "yes"): ?>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="admin/uprawnienia">Zmiana danych użytkowników</a></li>
            <li><a href="admin/accept">Akceptacja kursów</a></li>
      ...
      <?php endif; ?>
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="index/wysli">Wyśli wiadomość</a></li>
            <li><a href="index/odbierz">Skrzynka odbiorcza</a></li>
            <li><a href="#"></a></li>
